...
public class Trademethod {
	HashMap<String,Newstore> allTrade=new HashMap<String,Newstore>();
	...
	public void checkVersion(Newstore t,int version) throws Exception
	{
	...
	public void checkExpiredDates()
	{
		...
		for(String strKey : allTrade.keySet() ){
		    ...
		    {
		    		Newstore t=allTrade.get(strKey);
		    		t.setExpired('Y');
	...
	public void addTrade(Newstore T) throws Exception
	{
...
checkVersion(T, allTrade.get(T.getTradeId()).getVersion());
	...
	public Newstore getTrade(String tId) throws Exception
	{
